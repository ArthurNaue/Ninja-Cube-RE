...
@onready var killEffectScene = load("res://scenes/game/entities/player/kill_effect/root/killEffect.tscn")
...
func _physics_process(_delta: float) -> void:
	...
	var collision = move_and_collide(direction.normalized() * (moveSpeed * game.gamePace))
